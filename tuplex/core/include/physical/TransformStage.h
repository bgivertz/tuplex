...
namespace tuplex {
    ...
    public:
        ...
        void setInputPartitionInfo(std::vector<std::tuple<size_t, size_t, size_t>> info) { _inputPartitionInfo = info; }
        std::vector<std::tuple<size_t, size_t, size_t>> inputPartitionInfo() { return _inputPartitionInfo; }
